...
describe('Frontend', function() {
    ...
    it("should redirect to dashboard view on 'Account 4' button click", function(done) {
        browser.get('http://localhost:8080').then(function() {
            setTimeout(done, 1000);
            listOfUsers.last().click();
        });
    ...
    it("should load 'Account 4' as the text for my account in dashboard view", function() {
        var myAccount = element(by.css('.my-acc'));
        expect(myAccount.getText()).toBe('Account 4');
    });
