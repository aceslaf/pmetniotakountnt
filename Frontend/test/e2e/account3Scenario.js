...
describe('Frontend', function() {
    ...
    it("should redirect to dashboard view on 'Account 3' button click", function(done) {
        browser.get('http://localhost:8080').then(function() {
            setTimeout(done, 1000);
            listOfUsers.get(2).click();
        });
    ...
    it("should load 'Account 3' as the text for my account in dashboard view", function() {
        var myAccount = element(by.css('.my-acc'));
        expect(myAccount.getText()).toBe('Account 3');
    });
